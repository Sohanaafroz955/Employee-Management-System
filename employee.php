...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 >Welcome to Employee Management system</h1></div>
      </div>
   <div class="w3-container">
      <h4>Employee Data</h4>
       
       <a href="employee-add.php" class="w3-button w3-blue w3-right">Add employee
          <span class="w3-text-red">+</span></a>
       <br><br>
       <table>
...
<!-- W3.CSS Container -->
    ...
    <p class="w3-right">Reference <a href="https://www.w3schools.com/w3css/default.asp" 
