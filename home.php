<!DOCTYPE html>
<html lang="en">
<title>Welcome to my management Page</title>
<meta charset="UTF-8">
...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          <img src="working2.jpg" alt="Lights" style="width:100%" style="height: 150px">
          <div class="w3-display-middle w3-large" > <h1 >Welcome to My Management Page</h1></div>
      </div>
   <div class="w3-display-container w3-text-white">
  <img src="working3.jpg" alt="Lights" style="width:100%">
  ...
  <p>This is management page</p></div>
  <div class="w3-display-left w3-container"></div>
  <div class="w3-display-right w3-container"></div>
  <div class="w3-display-middle w3-large w3-text-black"></div>
...
<!-- W3.CSS Container -->
<div class="w3-dark-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px">
<p class="w3-right">References <a href="https://www.w3schools.com/w3css/default.asp"
 title="W3.CSS" target="_blank" class="w3-hover-opacity">Sohana Afroz</a></p></div>
